...
class StoreBuktiDigitalRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'file_url' => 'required|file|max:10240|mimes:jpg,jpeg,png,pdf,doc,docx,zip,rar', // Max 10MB
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'file_url.required' => 'File bukti harus diupload.',
