...
class DefacementDetectionService
{
    ...
    /**
     * Check a single monitored site for defacement by comparing SHA-256 of
     * the current response body with the stored baseline_hash.
     *
